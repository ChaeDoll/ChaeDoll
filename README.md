...
## 📄 Others
 ...
 - ### Activities & Study
   - 中 스마일게이트 Orange Planet Learning Mate 3기 참가 
   - 中 2024 XR 디바이스 아이디어톤 본선 진출
   - 中 알고리즘 스터디 (12주차)
   - 完 2024 환경 SW 개발 경진대회 피우다 프로젝트 참가
   - 完 2024 교내 SW경진대회 1차 서류 합격
   - 完 딥러닝 스터디 (10주차)
   - 完 일본어 언어 교환 프로그램 (7주차)
   - 完 SKT AI Fellowship 6기 1차 서류 합격
   - 完 2023 교내 SW경진대회 참가
   - 完 Java Spring Framework 스터디 (10주차)
 - ### TMI...🤫
